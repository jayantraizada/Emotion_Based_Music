...
song_text_box.insert("end", "Disclaimer\n\n"
                              ...
                              "Further any client to share the software code without legal consent of 'Mitansh Buwa' will be\n" 
                              "held guilty under information sharing and privacy act 1988.\n"
                              "It is a request for clients and users to not use software code or share software code without\n" 
                              "consent of Mitansh Buwa, otherwise consequence of law will take place.", "bold")  # Insert the text "Bold Text" with the "bold" tag
...
# Create a scrollbar for the song text box
scrollbar = Scrollbar(window, command=song_text_box.yview)
song_text_box.configure(yscrollcommand=scrollbar.set)
...
video_frame.grid(row=0, column=0, columnspan=3, padx=10, pady=10)
emotion_label.grid(row=1, column=0, pady=10, columnspan=3)
song_text_box.grid(row=0, column=3, rowspan=2, padx=10, pady=10, sticky="nsew")
scrollbar.grid(row=0, column=4, rowspan=2, sticky="ns")  # Add the scrollbar to the grid layout
